...
from network import MGN, Image_adapter, Image_adapter_77, Image_adapter_77_768
    ...
    def train(self, epoch):
        ...
        for batch, (inputs, labels, captions) in enumerate(self.train_loader):
            ...
            with torch.no_grad():
                ...
                text_embedding = text_outputs.last_hidden_state  # shape: (batch_size, 77, 768)
...
if __name__ == '__main__':
    ...
    if opt.mode == 'train':
        ...
        wandb.init(
            ...
            name=f"only_adapter_blip_0.5_0.5_2.0_margin2_temperature0.20_77_768"
        )
