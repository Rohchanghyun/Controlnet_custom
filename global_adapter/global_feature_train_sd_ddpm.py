...
class Main():
    ...
    def train(self, epoch):
        ...
        for batch, (inputs, labels, captions) in enumerate(pbar):
            ...
            with torch.no_grad():
                uncond_embeddings_large = self.text_encoder(uncond_text_input.input_ids)
                uncond_embeddings_large = uncond_embeddings_large.last_hidden_state
            ...
            if batch % 1000 == 0 and batch != 0:
                ...
                with torch.no_grad():
                    ...
                    # 노이즈 스케줄러 타임스텝 설정 수정
                    self.noise_scheduler.set_timesteps(50)  # 타임스텝 수 설정
                    ...
                    for t in timesteps:
                        ...
                        latents = self.noise_scheduler.step(
                            ...
                            timestep=t,
                            sample=latents,
                            generator=None  # 필요한 경우 torch.Generator()를 사용할 수 있습니다
                        ).prev_sample
...
if __name__ == '__main__':
    ...
    if opt.mode == 'train':
        ...
        wandb.init(
            ...
            name=f"sd_image_adapter_cfg_{opt.clip_embeddings_dim}_{opt.epoch}_{opt.lr}"
        )
