...
from pipeline.pipeline_controlnext_sketch import StableDiffusionXLControlNeXtSketchPipeline
...
def log_validation(vae, unet, controlnet, adapter, args, accelerator, weight_dtype, step, is_final_validation=False):
    ...
    pipeline = StableDiffusionXLControlNeXtSketchPipeline.from_pretrained(
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(unet, controlnet):
                ...
                controlnet_condition = controlnet_image
                controls = controlnet(
