...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=str,
        default="train",
        help="Mode of operation: train, test, or vis.",
    )
    parser.add_argument(
        "--query_image",
        type=str,
        default=None,
        help="Path to the query image for visualization mode.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help="Scale factor for controlnet.",
    )
    ...
    if args.data_path is None and args.dataset_name is None and args.train_data_dir is None:
        raise ValueError("Specify either `--data_path`, `--dataset_name` or `--train_data_dir`")
...
def main(args):
    ...
    data = Data(
        ...
        batchimage=args.batchimage,
        batchtest=args.batchtest,
        mode=args.mode,
    ...
    logger.info(f"  Num examples = {len(data.trainset)}")
